var SCRIPTS = [
  ...
  //test functions
  let living = (script) => script.living;
  let rtldirection = (script) => script.direction == 'rtl';


//  Function to filter through the array
...
// Displaying all living texts
console.log(filter(SCRIPTS,living));
...
let rtlscripts = filter(SCRIPTS,rtldirection);
...
//  Finding the average year of origin of living and dead scripts
